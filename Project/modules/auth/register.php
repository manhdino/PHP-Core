...
if (isPost()) {
    ...
    //Validate form
    $body = getBody(); //Lấy tất cả dữ liệu trong form submit bên dưới
    ...
    //Kiểm tra mảng $errors xem có lỗi Validation nào xảy ra không
    if (empty($errors)) {  //
        //Không có lỗi xảy ra
    ...
    <div class="col-6" style="margin: 20px auto;">
        ...
        <form action="" method="post">
            ...
            <div class="form-group">
                ...
                <input type="password" name="password" class="form-control" placeholder="Mật khẩu..." value="<?php echo old('password', $old) ?>">
            ...
            <div class="form-group">
                ...
                <input type="password" name="confirm_password" class="form-control" placeholder="Nhập lại mật khẩu..." value="<?php echo old('confirm_password', $old) ?>">
